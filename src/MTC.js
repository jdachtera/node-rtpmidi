...
MTC.prototype.setSource = function setSource(sessionOrStream) {
...
MTC.prototype.applySongPosition = function applySongPosition(message) {
...
MTC.prototype.applyFullTime = function applyFullTime(message) {
...
MTC.prototype.applyQuarterTime = function applyQuarterTime(message) {
...
MTC.prototype.getSMTPEString = function getSMTPEString() {
